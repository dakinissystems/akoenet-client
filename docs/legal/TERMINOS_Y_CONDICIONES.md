# Términos y Condiciones de Uso — AkoeNet
...
Titular: Christian
Correo de contacto: legal@dakinissystems.com
País/Jurisdicción: España

2. Objeto del servicio
AkoeNet ofrece una plataforma para comunidades y comunicación en tiempo real (servidores, canales, mensajes directos y funciones relacionadas).
...
En la máxima medida permitida por la ley, AkoeNet no será responsable por daños indirectos, lucro cesante o pérdida de datos derivados del uso del servicio.
...
12. Cobros y pagos
AkoeNet no procesa pagos con pasarela online (por ejemplo, Stripe) en la implementación actual.
Cuando aplique, el cobro se gestiona por transferencia fuera de la plataforma.

13. Contacto legal
Para consultas legales o notificaciones: legal@dakinissystems.com
